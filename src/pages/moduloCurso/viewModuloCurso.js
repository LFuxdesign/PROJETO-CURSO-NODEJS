                ...
                <div className="runningCourses flex flexColumn">
                    <span style={{ fontSize: "22px" }}>{moduloAtual.titulo}</span>
                    {
                        moduloAtual.conteudos.sessoes.map((sessao, index) => {
                            return (
                                <div key={index} className="cardCurso flexCenter" style={{ background: sessao.highlightColor }}>
                            ...
                            <div className="conteudoSessao flexCenter flexColumn">
                                <div className="medias flex flexColumn">
                                    <div className="infos flexCenter">
                                        <div className="disclaimer flexCenter">
                                        ...
                                        <div className="progressbar">
                                            {(() => {
                                                ...
                                                const percentage = (viewedCount / totalSessoes) * 100;

                                                return (
                                                    <>
                                                        <div style={{ width: percentage + "%" }} className="highlightColor" />
                                                        <span>
                                                            {percentage.toFixed(2) + "% concluido"}
                                                        </span>
                                                    </>
                                                )
                                            })()}
                                ...
                                <div className="textContent flex flexColumn">
