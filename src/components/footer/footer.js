...
export default function Footer() {
    ...
    useEffect(() => {
        const fetchProfilesData = async () => {
            ...
            const validProfiles = allData.filter((data) => data && !data.error);
    ...
    const languages = [
        ...
        },
        {
            ...
            logo: '<svg fill=none height=50 viewBox="0 0 50 50"width=50 xmlns=http://www.w3.org/2000/svg><path d="M25 0C12.1094 0 0 10.5469 0 25C0 41.0156 13.2813 50 25 50C22.2656 50 8.72396 47.0052 8.72396 28.3854C8.72396 16.7969 18.2292 10.2865 25 12.8906C25 12.8906 32.2917 15.625 32.2917 25C32.2917 34.375 25 37.1094 25 37.1094C31.6406 39.7135 41.276 33.5938 41.276 21.6146C41.276 4.81771 29.9479 0 25 0Z"fill=url(#paint0_linear_335_200) /><path d="M25 50C37.8906 50 50 39.4531 50 25C50 8.98438 36.7187 0 25 0C27.7344 0 41.276 2.99479 41.276 21.6146C41.276 33.2031 31.7708 39.7135 25 37.1094C25 37.1094 17.7083 34.375 17.7083 25C17.7083 15.625 25 12.8906 25 12.8906C18.3594 10.2865 8.72396 16.4063 8.72396 28.3854C8.72396 45.1823 20.0521 50 25 50Z"fill=url(#paint1_linear_335_200) /><defs><linearGradient gradientUnits=userSpaceOnUse id=paint0_linear_335_200 x1=7.22331 x2=46.5145 y1=7.5 y2=35.0212><stop/><stop offset=1 stop-color=white /></linearGradient><linearGradient gradientUnits=userSpaceOnUse id=paint1_linear_335_200 x1=42.7767 x2=3.48549 y1=42.5 y2=14.9788><stop/><stop offset=1 stop-color=white /></linearGradient></defs></svg>',
        ...
        },
        {
            ...
            logo: '<svg fill=none height=55 viewBox="0 0 40 55"width=40 xmlns=http://www.w3.org/2000/svg><path d="M35.7293 50.6874L19.7128 55L3.69597 50.6874L-3.05176e-05 10.646H39.4258L35.7293 50.6874Z"fill=#2062AF /><path d="M19.7126 14.1174V51.7885L19.7488 51.7984L32.7104 48.3081L35.7021 14.1174H19.7126Z"fill=#3C9CD7 /><path d="M10.6227 4.99111V2.60785H14.0998V0H8.01483V7.37083H14.0998V4.99111H10.6227ZM20.3549 2.60785H22.7859V0H16.7003V2.60785C17.5145 3.42202 17.9391 3.81171 19.1166 4.98922C18.4282 4.98922 16.7003 4.99158 16.7003 4.99158V7.37083H22.7859V4.99111L20.3549 2.60785ZM28.9802 2.60785H31.411V0H25.3252V2.60785C26.1394 3.42202 26.5642 3.81171 27.7417 4.98922C27.0536 4.98922 25.3252 4.99158 25.3252 4.99158V7.37083H31.4112V4.99111L28.9802 2.60785Z"fill=black /><path d="M19.6984 24.1292L8.23483 28.9035L8.61499 33.6304L19.6984 28.8915L31.4883 23.8508L31.9771 19.0154L19.6984 24.1292Z"fill=white /><path d="M8.23473 28.9034L8.61489 33.6303L19.6983 28.8914V24.1292L8.23473 28.9034Z"fill=url(#paint0_linear_335_215) /><path d="M31.9771 19.0156L19.6984 24.1294V28.8917L31.4883 23.8509L31.9771 19.0156Z"fill=url(#paint1_linear_335_215) /><path d="M8.25237 28.9036L8.63264 33.6305L25.6387 33.6847L25.2583 39.9871L19.6623 41.5625L14.2829 40.2043L13.957 36.2924H8.95859L9.61062 43.8444L19.7166 46.8326L29.7679 43.8986L31.0719 28.9036H8.25237Z"fill=url(#paint2_linear_335_215) /><path d="M19.3487 29.175H7.88513L8.26529 33.9019L19.3487 33.9373V29.175ZM19.3487 41.819L19.2944 41.8341L13.9157 40.4759L13.5898 36.564H8.59148L9.24338 44.116L19.3487 47.1042V41.819Z"fill=black opacity=0.05 /><path d="M7.20242 19.0156H31.9771L31.4883 23.851H7.8L7.20242 19.0156Z"fill=url(#paint3_linear_335_215) /><path d="M19.6984 19.0156H7.20242L7.8 23.851H19.6984V19.0156Z"fill=black opacity=0.05 /><defs><linearGradient gradientUnits=userSpaceOnUse id=paint0_linear_335_215 x1=13.9665 x2=13.9665 y1=33.6304 y2=24.1293><stop stop-color=#D1D3D4 offset=0.387 stop-opacity=0 /><stop stop-color=#D1D3D4 offset=1 /></linearGradient><linearGradient gradientUnits=userSpaceOnUse id=paint1_linear_335_215 x1=25.8376 x2=25.8376 y1=28.8918 y2=19.0157><stop stop-color=#D1D3D4 offset=0.387 stop-opacity=0 /><stop stop-color=#D1D3D4 offset=1 /></linearGradient><linearGradient gradientUnits=userSpaceOnUse id=paint2_linear_335_215 x1=8.25237 x2=31.0718 y1=37.8682 y2=37.8682><stop stop-color=#E8E7E5 /><stop stop-color=white offset=1 /></linearGradient><linearGradient gradientUnits=userSpaceOnUse id=paint3_linear_335_215 x1=7.20242 x2=31.977 y1=21.4333 y2=21.4333><stop stop-color=#E8E7E5 /><stop stop-color=white offset=1 /></linearGradient></defs></svg>',
